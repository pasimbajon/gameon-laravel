...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" style="float:left;">Register</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\ploys\OneDrive\Documents\GitHub\gameon-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>
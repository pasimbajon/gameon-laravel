...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/css/Table.css')); ?>">
...
<body>
    ...
    <div class="game">
        <div class="content">
            <a href="/discover/counter-strike_global_offensive" class='GameCover'><img src="<?php echo e(url('/images/GAMES/COUNTER-STRIKE GLOBAL OFFENSIVE/CSGO_Cover.png')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
        ...
        <div class="content">
            <a href="/discover/dota_2" class='GameCover'><img src="<?php echo e(url('/images/GAMES/DOTA 2/DOTA2_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/apex_legends" class='GameCover'><img src="<?php echo e(url('/images/GAMES/APEX LEGENDS/APEX_COVER.jpg')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/pubg_battlegrounds" class='GameCover'><img src="<?php echo e(url('/images/GAMES/PUBG/PUBG_Cover.png')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/team_fortress_2" class='GameCover'><img src="<?php echo e(url('/images/GAMES/TEAM FORTRESS 2/TF_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/rust" class='GameCover'><img src="<?php echo e(url('/images/GAMES/RUST/RUST_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/grand_theft_auto_V" class='GameCover'><img src="<?php echo e(url('/images/GAMES/GRAND THEFT AUTO V/GTAV_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/call_of_duty_modern_warfare_II" class='GameCover'><img src="<?php echo e(url('/images/GAMES/CALL OF DUTY MODERN WARFARE II/CODMWII_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
          <a href="/discover/destiny_2" class='GameCover'><img src="<?php echo e(url('/images/GAMES/DESTINY 2/DESTINY2_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
          <div class='GameDesc'>
        ...
        <div class="content">
            <a href="/discover/age_of_wonders_4" class='GameCover'><img src="<?php echo e(url('/images/GAMES/AGE OF WONDERS 4/AOW4_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
        ...
        <div class="content">
            <a href="/discover/asssassins_creed_origins" class='GameCover'><img src="<?php echo e(url('/images/GAMES/ASSASSINS CREED ORIGINS/ACO_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
        ...
        <div class="content">
            <a href="/discover/ea_sports_fifa_23" class='GameCover'><img src="<?php echo e(url('/images/GAMES/EA SPORTS FIFA 23/FIFA_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
          ...
          <div class="content">
            <a href="/discover/hogwarts_legacy" class='GameCover'><img src="<?php echo e(url('/images/GAMES/HOGWARTS LEGACY/HL_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
          ...
          <div class="content">
            <a href="/discover/marvels_guardians_of_the_galaxy" class='GameCover'><img src="<?php echo e(url('/images/GAMES/MARVELS GUARDIANS OF THE GALAXY/GOTG_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
          ...
          <div class="content">
            <a href="/discover/monster_hunter_rise" class='GameCover'><img src="<?php echo e(url('/images/GAMES/MONSTER HUNTER RISE/MHR_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
          ...
          <div class="content">
            <a href="/discover/monster_hunter_world" class='GameCover'><img src="<?php echo e(url('/images/GAMES/MOSNTER HUNTER WORLD/MHW_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
          ...
          <div class="content">
            <a href="/discover/sons_of_the_forest" class='GameCover'><img src="<?php echo e(url('/images/GAMES/SONS OF THE FOREST/SOTF_Cover.avif')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
          ...
          <div class="content">
            <a href="/discover/star_wars_jedi_survivor" class='GameCover'><img src="<?php echo e(url('/images/GAMES/STAR WARS JEDI SURVIVOR/SWJS_Cover.jpg')); ?>" alt='img' class='gameimage'></a>
            <div class='GameDesc'>
...
<?php echo $__env->make('pages.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ploys\OneDrive\Documents\GitHub\gameon-laravel\resources\views/pages/discover.blade.php ENDPATH**/ ?>
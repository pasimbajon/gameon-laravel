              ...
              <?php if(Route::has('login')): ?>
                    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                      <?php if(auth()->guard()->check()): ?>
                          <a class="nav-link text-light" href="<?php echo e(url('/dashboard')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                      <?php else: ?>
                          <a class="nav-link text-light" href="<?php echo e(route('login')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>
                      <?php endif; ?>
                    </div>
                  <?php endif; ?>
            </li>
        ...
        <div class='Footer-Content'>
          ...
          <div class='Contacts'>
            <div class='contact-icons'>
              <img class='logo' src="<?php echo e(url('/images/ICONS/facebook.png')); ?>" alt='logo'>
              <img class='logo' src="<?php echo e(url('/images/ICONS/instagram.png')); ?>" alt='logo'>
              <img class='logo' src="<?php echo e(url('/images/ICONS/twitter.png')); ?>" alt='logo'>
            </div>
          </div>
          <div>
...
</html><?php /**PATH C:\Users\ploys\OneDrive\Documents\GitHub\gameon-laravel\resources\views/pages/layout.blade.php ENDPATH**/ ?>